...
namespace Sample.PolicyRecordingBot.FrontEnd.Http
{
    ...
    public class PlatformCallController : ApiController
    {
        ...
        [System.Web.Http.Route(HttpRouteConstants.OnIncomingRequestRoute)]
        ...
        /// </returns>
        [System.Web.Http.HttpPost]
        [System.Web.Http.Route(HttpRouteConstants.OnNotificationRequestRoute)]
